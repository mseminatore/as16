...
start:  
        lwi sp, RAM_END     # setup SP to point to top of RAM
        lwi r4, SSEG        # point R5 to SSEG display
        add r1, r0, r0      # zero R1
        lwi r2, disp        # get address of disp routine

loop:   inc r1              # increment counter in R1
        call r2             # call subroutine to update display
        beq r0, r0, loop    # do it again

disp:   sw r1, r4, 0        # output to SSEG
        ret                 # return
